...
test('Converts to Vue2 component', async ({ page }) => {
  ...
  await test.step('Component Editor has the expected content (Vue2 javascript)', async () => {
